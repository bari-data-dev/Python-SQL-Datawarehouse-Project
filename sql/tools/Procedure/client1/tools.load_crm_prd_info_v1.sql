CREATE OR REPLACE PROCEDURE "tools"."load_crm_prd_info_v1"(IN p_client_schema VARCHAR, IN p_batch_id VARCHAR, OUT is_success BOOLEAN, OUT error_message TEXT) LANGUAGE PLPGSQL
AS
$$
